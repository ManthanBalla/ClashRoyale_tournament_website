...
class Payment(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    order_id = models.CharField(max_length=100, unique=True, null=True, blank=True, help_text='Cashfree Order ID')
    ...
    def __str__(self):
        return f"{self.user.username} - ₹{self.amount} - {self.order_id} - {self.status}"
